...
TypeTextOnElementByXpathAction::TypeTextOnElementByXpathAction(const nlohmann::json& json) : OptionalAction(json) {
...
const std::string& TypeTextOnElementByXpathAction::Text() const { return text_; }

const std::string& TypeTextOnElementByXpathAction::Xpath() const { return xpath_; }
