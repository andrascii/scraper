...
GetImagesByXpathAction::GetImagesByXpathAction(const nlohmann::json& json) : OptionalAction{json} {
...
const std::string& GetImagesByXpathAction::Xpath() const { return xpath_; }

const std::string& GetImagesByXpathAction::OutField() const { return out_field_; }
